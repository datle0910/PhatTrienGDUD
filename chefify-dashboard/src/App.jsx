      ...
      <div className="bg-white border-r border-gray-200 grid grid-rows-[auto_1fr_auto]">
        ...
        <div className="px-3 py-4">
          <div className="grid gap-1">
            <Link 
              to="/" 
              className={`grid grid-cols-[auto_1fr] items-center px-3 py-2 rounded-md ${
            ...
            <Link 
              to="/projects" 
              className={`grid grid-cols-[auto_1fr] items-center px-3 py-2 rounded-md ${
                location.pathname === '/projects' ? 'bg-pink-500 text-white' : 'text-gray-600 hover:bg-gray-100'
              }`}
            >
              <span className="mr-3">
            ...
            <Link 
              to="/teams" 
              className={`grid grid-cols-[auto_1fr] items-center px-3 py-2 rounded-md ${
                location.pathname === '/teams' ? 'bg-pink-500 text-white' : 'text-gray-600 hover:bg-gray-100'
              }`}
            >
              <span className="mr-3">
            ...
            <Link 
              to="/analytics" 
              className={`grid grid-cols-[auto_1fr] items-center px-3 py-2 rounded-md ${
                location.pathname === '/analytics' ? 'bg-pink-500 text-white' : 'text-gray-600 hover:bg-gray-100'
              }`}
            >
              <span className="mr-3">
            ...
            <Link 
              to="/messages" 
              className={`grid grid-cols-[auto_1fr] items-center px-3 py-2 rounded-md ${
                location.pathname === '/messages' ? 'bg-pink-500 text-white' : 'text-gray-600 hover:bg-gray-100'
              }`}
            >
              <span className="mr-3">
            ...
            <Link 
              to="/integrations" 
              className={`grid grid-cols-[auto_1fr] items-center px-3 py-2 rounded-md ${
                location.pathname === '/integrations' ? 'bg-pink-500 text-white' : 'text-gray-600 hover:bg-gray-100'
              }`}
            >
              <span className="mr-3">
...
const ProjectsPage = () => (
  <div className="p-6">
    ...
    <div className="bg-white p-6 rounded-lg shadow">
      <p className="text-gray-600">Your projects will be displayed here.</p>
    </div>
  </div>
);
...
const TeamsPage = () => (
  <div className="p-6">
    ...
    <div className="bg-white p-6 rounded-lg shadow">
      <p className="text-gray-600">Your team information will be displayed here.</p>
    </div>
  </div>
);
...
const AnalyticsPage = () => (
  <div className="p-6">
    ...
    <div className="bg-white p-6 rounded-lg shadow">
      <p className="text-gray-600">Your analytics data will be displayed here.</p>
    </div>
  </div>
);
...
const IntegrationsPage = () => (
  <div className="p-6">
    ...
    <div className="bg-white p-6 rounded-lg shadow">
      <p className="text-gray-600">Your integrations will be displayed here.</p>
    </div>
  </div>
);
